...
import { getResolvedGrievances } from "@/services/admin.service";
...
const CampusAdminResolvedGrievancesPage = () => {
  useAuthRedirect();
  ...
  useEffect(() => {
    if (!isCampusAdmin) {
      setError(
        "Access denied. Only campus admins can view resolved grievances."
      );
      setLoading(false);
      return;
    }
  ...
  useEffect(() => {
    ...
    // Filter by RESOLVED status for this page
  ...
  const fetchGrievances = useCallback(
    async (isRetry = false) => {
      try {
        ...
        const response: ApiResponse = await getResolvedGrievances();
        ...
        if (response.success) {
          ...
          throw new Error(
            response.message || "Failed to fetch resolved grievances"
          );
        }
      } catch (err: any) {
        ...
        const errorMessage =
          err.message ||
          "Failed to fetch resolved grievances. Please check your connection and try again.";
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md mx-auto bg-white rounded-lg shadow-md p-8 text-center">
          ...
          <p className="text-gray-600 mb-4">
            You need campus admin privileges to view resolved grievances.
          </p>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">
                Resolved Grievances - Campus Admin
              </h1>
              <p className="text-gray-600 mt-1">
                View all resolved grievances for your campus (
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-12 text-center">
              ...
              <p className="text-gray-600">
                {searchTerm || typeFilter !== "all" || campusFilter !== "all"
                  ...
                  : "No resolved grievances at the moment."}
              </p>
            </div>
          ) : (
                ...
                <div className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <button
                      ...
                      className="px-3 py-1 text-green-600 hover:bg-green-50 rounded-lg transition-colors flex items-center gap-1"
                    >
...
export default CampusAdminResolvedGrievancesPage;
