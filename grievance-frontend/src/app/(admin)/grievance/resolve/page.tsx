...
const ResolvedGrievancesPage = () => {
  ...
  useEffect(() => {
    if (!isSuperAdmin) {
      setError(
        "Access denied. Only super admins can view resolved grievances."
      );
      setLoading(false);
      return;
    }
  ...
  useEffect(() => {
    ...
    // Always filter by RESOLVED status for this page
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md mx-auto bg-white rounded-lg shadow-md p-8 text-center">
          ...
          <p className="text-gray-600 mb-4">
            You need super admin privileges to view resolved grievances.
          </p>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading resolved grievances...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">
                Resolved Grievances - Super Admin View
              </h1>
              <p className="text-gray-600 mt-1">
                Manage and review all resolved grievances (
...
export default ResolvedGrievancesPage;
