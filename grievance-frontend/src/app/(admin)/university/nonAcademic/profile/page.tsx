...
const dummyUniversityNonAcademicAdmin = {
  name: "Pankaj Sharma",
  adminId: "UNINONACAD2025",
  email: "pankaj.sharma@university.edu",
  phone: "+91 98765 12345",
  role: "University Non-Academic Admin",
  campus: "National University of Technology",
  department: "Non-Academic Affairs",
  joinDate: "March 2023",
...
export default function UniversityNonAcademicAdminProfilePage() {
  return (
    <div className="min-h-screen w-full p-4 sm:p-6 bg-gradient-to-br from-blue-50/50 via-white to-purple-50/30">
      <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="flex-1 text-center md:text-left">
              <div className="flex items-center justify-center md:justify-start gap-3 mb-2">
                <h1 className="text-4xl font-bold bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent">
                  {dummyUniversityNonAcademicAdmin.name}
                </h1>
              ...
              <div className="flex flex-col md:flex-row md:items-center md:gap-6 gap-2 text-blue-100 mb-4">
                <span className="flex items-center justify-center md:justify-start gap-2">
                  ...
                  <span className="text-lg font-medium">{dummyUniversityNonAcademicAdmin.adminId}</span>
                </span>
                <span className="flex items-center justify-center md:justify-start gap-2">
                  <ShieldCheck className="w-5 h-5" />
                  <span className="text-lg font-medium">{dummyUniversityNonAcademicAdmin.role}</span>
                </span>
              </div>
              {/* Quick Stats */}
              <div className="grid grid-cols-2 md:grid-cols-2 gap-4 mt-6">
                <div className="text-center p-3 bg-white/10 rounded-lg backdrop-blur-sm">
                  <div className="text-2xl font-bold text-white">{dummyUniversityNonAcademicAdmin.permissions}</div>
                  <div className="text-sm text-blue-200">Permissions</div>
                </div>
                <div className="text-center p-3 bg-white/10 rounded-lg backdrop-blur-sm">
                  <div className="text-2xl font-bold text-white">{dummyUniversityNonAcademicAdmin.managedUsers}</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <ProfileField icon={<Mail />} label="Email Address" value={dummyUniversityNonAcademicAdmin.email} />
            <ProfileField icon={<Phone />} label="Phone Number" value={dummyUniversityNonAcademicAdmin.phone} />
          </InfoCard>
          {/* Work Information */}
          <InfoCard 
          ...
          >
            <ProfileField icon={<Building2 />} label="Campus" value={dummyUniversityNonAcademicAdmin.campus} />
            <ProfileField icon={<User />} label="Department" value={dummyUniversityNonAcademicAdmin.department} />
          </InfoCard>
          ...
          >
            <ProfileField icon={<Calendar />} label="Join Date" value={dummyUniversityNonAcademicAdmin.joinDate} />
            <ProfileField icon={<MapPin />} label="Last Login" value={dummyUniversityNonAcademicAdmin.lastLogin} />
          </InfoCard>
        </div>
        {/* Privileges Card */}
        <InfoCard 
          title="University Non-Academic Privileges" 
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-center gap-2 text-gray-700">
                  ...
                  Manage university non-academic events
                </li>
                <li className="flex items-center gap-2 text-gray-700">
                  <div className="w-2 h-2 bg-pink-500 rounded-full"></div>
                  Oversee hostel and facility operations
                </li>
                <li className="flex items-center gap-2 text-gray-700">
                  <div className="w-2 h-2 bg-pink-500 rounded-full"></div>
                  Coordinate with non-academic staff
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-center gap-2 text-gray-700">
                  ...
                  Address non-academic grievances
                </li>
                <li className="flex items-center gap-2 text-gray-700">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  Approve hostel and facility requests
                </li>
                <li className="flex items-center gap-2 text-gray-700">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  Generate non-academic reports
                </li>
              </ul>
            </div>
          </div>
