...
import { getPendingGrievances } from "@/services/admin.service";
...
const PendingGrievancesPage = () => {
  ...
  useEffect(() => {
    if (!isSuperAdmin) {
      setError("Access denied. Only super admins can view pending grievances.");
      setLoading(false);
      return;
    }
  ...
  useEffect(() => {
    ...
    // Since this is the pending page, getPendingGrievances already returns only pending grievances
    // No need to filter by status again
  ...
  const fetchGrievances = useCallback(
    async (isRetry = false) => {
      try {
        ...
        const response: ApiResponse = await getPendingGrievances();
        ...
        if (response.success) {
          ...
          throw new Error(response.message || "Failed to fetch pending grievances");
        }
      } catch (err: any) {
        ...
        const errorMessage =
          err.message ||
          "Failed to fetch pending grievances. Please check your connection and try again.";
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md mx-auto bg-white rounded-lg shadow-md p-8 text-center">
          ...
          <p className="text-gray-600 mb-4">
            You need super admin privileges to view pending grievances.
          </p>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 text-lg mb-2">Loading pending grievances...</p>
          {retryCount > 0 && (
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">
                Pending Grievances - Super Admin View
              </h1>
              <p className="text-gray-600 mt-1">
                Manage and review all pending grievances (
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-12 text-center">
              ...
              <p className="text-gray-600">
                {searchTerm || typeFilter !== "all" || campusFilter !== "all"
                  ...
                  : "No pending grievances at the moment."}
              </p>
            </div>
          ) : (
...
export default PendingGrievancesPage;
