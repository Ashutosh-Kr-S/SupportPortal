...
const CampusAdminRejectedGrievancesPage = () => {
  useAuthRedirect();
  ...
  useEffect(() => {
    if (!isCampusAdmin) {
      setError(
        "Access denied. Only campus admins can view rejected grievances."
      );
      setLoading(false);
      return;
    }
  ...
  useEffect(() => {
    ...
    // Filter by REJECTED status for this page
    ...
    async (isRetry = false) => {
      try {
        ...
        if (response.success) {
          ...
          throw new Error(
            response.message || "Failed to fetch rejected grievances"
          );
        }
      } catch (err: any) {
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md mx-auto bg-white rounded-lg shadow-md p-8 text-center">
          ...
          <p className="text-gray-600 mb-4">
            You need campus admin privileges to view rejected grievances.
          </p>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">
                Rejected Grievances - Campus Admin
              </h1>
              <p className="text-gray-600 mt-1">
                View all rejected grievances for your campus (
              ...
              >
                <div className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <button
                      onClick={() => handleViewGrievance(grievance.issuse_id)}
...
export default CampusAdminRejectedGrievancesPage;
